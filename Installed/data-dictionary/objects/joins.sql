...
--dba_lob                                                                                   
  ...
  dba_views          vie on obj.owner       = vie.         owner and obj.object_name = vie.    view_name
order by
  case when obj.object_type in (
    'CLUSTER', 'EDITION', 'INDEX', 'LOB', 'PACKAGE', 'PACKAGE BODY', 'QUEUE', 'SEQUENCE', 'SYNONYM', 'TABLE', 'TYPE', 'VIEW')
   then 1 else 0 end
;
